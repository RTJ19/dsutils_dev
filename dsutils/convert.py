"""
Github user zaloogarcia have developed some functions that will help in 
...
It was further forked by tonyfraser into a class format which creates
a dict type that contains df.dtypes AND type(pd.columnname)

https://gist.github.com/tonyfraser/79a255aa8a9d765bd5cf8bd13597171e
